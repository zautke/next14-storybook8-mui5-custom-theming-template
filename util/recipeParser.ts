      ...
      recipeSchema = {
        ...
        ...(item.review && {
          review: item.review.map((rev: Review) => ({
            ...
            reviewRating: typeof rev.reviewRating === 'object' ? rev.reviewRating.ratingValue : "No rating",
          })),
        }),
      };
    } catch (e) {
              ...
              ...(item.review && {
                review: item.review.map((rev: Review) => ({
                  ...
                  reviewRating: rev.reviewRating
                    ? (typeof rev.reviewRating === 'object' ? rev.reviewRating.ratingValue : "No rating")
                    : "No rating",
                })),
              }),
            };
