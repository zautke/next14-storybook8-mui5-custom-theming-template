...
version_nginx=$(curl -sL ${source_nginx} | grep -Eo '[0-9.]+[13579]\.[0-9]+' | sort -V | tail -n 1)
...
#gpg --batch --verify nginx.tar.gz.asc nginx.tar.gz  <-- public key not found
